...
<head>
  ...
  <style>
        ...
        @media (max-width: 400px) {
            ...
            .inline-flex {
                    margin-bottom: 5px; /* Adds spacing for vertical stacking in smaller screens */
                }

            #registration-form {
                max-height: 100vh !important; /* Limit the height to 90% of the viewport height */
        ...
        body, html {
          ...
          #registration-form {
            max-height: 85vh; /* Limit the height to 90% of the viewport height */
            overflow-y: auto; /* Enable vertical scrolling */
            padding-bottom: 20px; /* Ensure there's some space at the bottom */
          }
            .password-container {
...
<body>
    ...
    <form id="registration-form" action="/register" method="POST" enctype="multipart/form-data" class="space-y-4 -mt-2 p-6 mx-auto form-container">
            @csrf
            ...
            <fieldset class="border border-muted rounded-lg p-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-black" for="dob">Date of Birth (dd/mm/yy) *</label>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="inline-flex items-center mb-2">
                                <input type="radio" name="gender" value="prefer-not-say" class="mr-2" />
            ...
            <fieldset class="border border-muted rounded-lg p-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="password-container">
                        ...
                        <input class="border border-border rounded-lg p-2 w-full text-black" type="password" id="password" name="password" placeholder="Enter your password" required />
                        <i class="icofont-eye toggle-password" id="toggle-password" data-target="password"></i>
                    </div>
                    <div class="password-container">
                        <label for="password_confirmation" class="form-label text-black">Confirm Password *</label>
                        <input type="password" class="border border-border rounded-lg p-2 w-full" id="password_confirmation" id="password_confirmation" name="password_confirmation" placeholder="Confirm your password" required>
                        <i class="icofont-eye toggle-password" id="toggle-password-confirm" data-target="password_confirmation"></i>
                    </div>
                </div>
            </fieldset>

    ...
    <div class="card mw-table">
        <div class="mw-header">
            <div class="d-flex align-items-center">
                <h4 class="mw-title">Manage Patient Account</h4>
                <input type="text" id="search" class="form-control" style="margin-left: 580px;" placeholder="Search..." />
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title font-semibold text-black" id="editUserLabel">View Patient Information</h5>
            ...
            <form id="viewClientForm">
                <div class="modal-body">
                    ...
                    <h6 class="mb-4 text-xl font-semibold">Personal Information</h6>
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="editFname" class="form-label">First Name</label>
                            <input type="text" class="form-control-plaintext" name="f_name" id="editFname" readonly>
                        </div>
                        <div class="col-md-4">
                            <label for="editMname" class="form-label">Middle Name</label>
                            <input type="text" class="form-control-plaintext" name="m_name" id="editMname" readonly>
                        </div>
                        <div class="col-md-4">
                            <label for="editLname" class="form-label">Last Name</label>
                            <input type="text" class="form-control-plaintext" name="l_name" id="editLname" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control-plaintext" name="suffix" id="editSuffix" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="editBday" class="form-label">Birthday</label>
                            <input type="date" class="form-control-plaintext" name="bday" id="editBday" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="gender" id="editGender" disabled>
                    ...
                    <!-- Contact Information -->
                    <h6 class="my-4 text-xl font-semibold">Contact Information</h6>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="editContactNo" class="form-label">Contact Number</label>
                            <input type="text" class="form-control-plaintext" name="contactNo" id="editContactNo" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="editEmail" class="form-label">Email</label>
                            <input type="email" class="form-control-plaintext" name="email" id="editEmail" readonly>
                        </div>
                    </div>

                    <!-- Address Information -->
                    <h6 class="my-4 text-xl font-semibold">Address Information</h6>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="editStreet" class="form-label">Street</label>
                            <input type="text" class="form-control-plaintext" name="street" id="editStreet" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="editBrgy" class="form-label">Barangay</label>
                            <input type="text" class="form-control-plaintext" name="brgy" id="editBrgy" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control-plaintext" name="municipality" id="editMunicipality" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="editProvince" class="form-label">Province</label>
                            <input type="text" class="form-control-plaintext" name="province" id="editProvince" readonly>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control-plaintext" name="zip_code" id="editZipCode" readonly>
                        </div>
                    </div>

                    <!-- Upload ID -->
                    <h6 class="my-4 text-xl font-semibold">Identification</h6>
                    <div class="row">
                        <div class="col-md-6">

                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title font-semibold text-black" id="addClientLabel">Add New Staff</h5>
            ...
            <div class="modal fade rhu-modal" id="editStaffAccount" tabindex="-1" aria-labelledby="editStaffLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h5 class="modal-title font-semibold text-black" id="editStaffLabel">Edit Staff Account</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control capitalize-input w-100" name="f_name" id="editFname">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="editMname" class="form-label">Middlename</label>
                                        <input type="text" class="form-control capitalize-input w-100" name="m_name" id="editMname">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="editLname" class="form-label">Lastname</label>
                                        <input type="text" class="form-control capitalize-input w-100" name="l_name" id="editLname">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <select class="form-select w-100" name="department" id="editDepartment" required>
                                            <option selected value="LABORATORY">LABORATORY</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="editStatus" class="form-label">Status</label>
                                        <select class="form-select w-100" name="status" id="editStatus" required>
                                            <option value="Active">Active</option>
                                            <option value="Inactive">Inactive</option>
                                        </select>
                                    </div>

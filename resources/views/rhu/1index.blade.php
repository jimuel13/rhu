	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4 col-sm-6">
				<div class="about-img">
					<img src="images/about/Blood.jpg" alt="" class="img-fluid">
					<img src="images/about/Consultation.jpg" alt="" class="img-fluid mt-4">
				</div>
			</div>
			<div class="col-lg-4 col-sm-6">
				<div class="about-img mt-4 mt-lg-0">
					<img src="images/about/Laboratory.jpg" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-4">
...
<section class="cta-section ">
    ...
    <section class="section service gray-bg" id="rhu-services" style="margin-bottom: -10rem;">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 service-laboratory">
                            <img src="images/service/service-1.jpg" alt="Laboratory" class="img-fluid">
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 service-consultation">
                            <img src="images/service/service-2.jpg" alt="Consultation" class="img-fluid">
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 service-vaccination">
                            <img src="images/service/service-3.jpg" alt="Vaccination" class="img-fluid">
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-block mb-5 service-other">
                            <img src="images/service/service-4.jpg" alt="other" class="img-fluid">
                            <div class="content">
                                <h4 class="mt-4 mb-2 title-color">Other's</h4>
                                <p class="mb-4">Services that has fee's to consider.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="page-title bg-1 " id="rhu-about">
    <div class="overlay"></div>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
  ...
  <section class="section about-page">
      <div class="container">
          <div class="row">
              <div class="col-lg-4">
                  <h2 class="title-color">A History of RHU Lucban, Quezon</h2>
              </div>
              <div class="col-lg-8">
          ...
          <div class="row">
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item mb-5 mb-lg-0">
                      ...
                      <h4 class="mt-3">Mayor Armando M. Racelis</h4>
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item">
                      ...
                      <h4 class="mt-3">RHU Health Workers</h4>
          ...
          <div class="row" id="teamContainer">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block mb-5 mb-lg-0"
                      ...
                      <div class="content">
                          <h4 class="mt-4 mb-0">Hon. Mariano (Jun) Ver</h4>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block mb-5 mb-lg-0"
                       data-name="Dr. Luis S. Mallari III"
                       data-position="Municipal Health Officer"
                       data-work-position="Leads municipal health services and medical operations"
                       data-location="Municipal Health Office, Main Health Center"
                       data-schedule="Monday-Saturday, 7:00 AM - 6:00 PM">
                      <img src="images/people/Mallari.png" alt="Dr. Luis S. Mallari III" class="img-fluid w-100">
                      <div class="content">
                          <h4 class="mt-4 mb-0">Dr. Luis S. Mallari III</h4>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block mb-5 mb-lg-0"
                       data-name="Siamon John"
                       data-position="Head Nurse"
                       data-work-position="Coordinates nursing staff and patient care management"
                       data-location="RHU, Nursing Station"
                       data-schedule="Rotating shifts, Available 24/7">
                      <img src="images/people/charm.jpg" alt="Siamon John" class="img-fluid w-100">
                      <div class="content">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block mb-5 mb-lg-0"
                       ...
                       data-position="Chief Medical Officer"
                       data-work-position="Oversees clinical operations and medical strategy"
                       data-location="Chief Medical Officer's Office, RHU"
                       data-schedule="Monday-Friday, 8:00 AM - 4:30 PM">
                      <img src="images/people/nikki.jpg" alt="Emily Rodriguez" class="img-fluid w-100">
                      <div class="content">
                          <h4 class="mt-4 mb-0">Emily Rodriguez</h4>
  ...
  <section class="section contact-info pb-0" id="rhu-contact">
      <div class="container">
          <div class="section-title text-center">
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="news-thumb wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="news-info">
                            ...
                            <div class="author">
                                <img src="images/people/default-author.png" class="img-fluid" alt="">
...
<section class="py-16 bg-white" id="rhu-appointment">
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-between items-start">
            ...
            <div class="text-center w-1/3">
                ...
                <!-- Dropdown added here -->
                <div class="mt-4">
                    <select id="serviceSelect" class="form-select form-select-lg mb-3" aria-label="Service Selection" onchange="showForm()">
        ...
        <x-rhu-appointment :appointments="$appointments" :tests="$tests" />

            ...
            <div class="mw-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ url('/export/vax_appointments') }}" id="exportAppointments" class="btn btn-sm mr-2" style="border: 1px solid; border-radius: 10px;">Export</a>
                        <a href="{{ url('/export/vax_blood-donation') }}" id="exportBloodDonation" class="btn btn-sm mr-2" style="border: 1px solid; border-radius: 10px; display: none;">Export</a>
                            ...
                            @if ($blood_appointments->isNotEmpty())
                                @foreach ($blood_appointments as $blood_appointment)
                                    <tr class="mw-column-name">
                                        ...
                                        <td>{{ $blood_appointment->dose_number }}</td>
